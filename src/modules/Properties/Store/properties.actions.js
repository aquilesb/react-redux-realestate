...
import { updateSearchParams, resetSearchParams } from '@/modules/Search/Store/search.actions';
...
import {
  ...
  PROPERTIES_GET_FEATURED_PROP_FAILURE,
  PROPERTIES_GET_RECOMMENDED,
  PROPERTIES_GET_RECOMMENDED_SUCCESS,
  PROPERTIES_GET_RECOMMENDED_FAILURE,
  PROPERTIES_GET_HOT,
  PROPERTIES_GET_HOT_SUCCESS,
  PROPERTIES_GET_HOT_FAILURE,
  PROPERTIES_GET_NEW,
  PROPERTIES_GET_NEW_SUCCESS,
  PROPERTIES_GET_NEW_FAILURE,
  PROPERTIES_SEARCH,
  PROPERTIES_SEARCH_SUCCESS,
  PROPERTIES_SEARCH_FAILURE,
} from './properties.actionTypes';
